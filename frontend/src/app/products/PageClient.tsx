...
const Page: React.FC<PageClientProps> = ({ searchParams }) => {
  ...
  const [selectedSizes, setSelectedSizes] = useState<string[]>(searchParams.size?.split(",") || []);
  const [currentPage, setCurrentPage] = useState(parseInt(searchParams.page || "1"));
  const [productsPerPage, setProductsPerPage] = useState(parseInt(searchParams.limit || "12"));
